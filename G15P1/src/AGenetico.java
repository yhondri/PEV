...
public class AGenetico {
	...
	private Cromosoma[] sigPob; // población de individuos
	private int tamPob = 100; // tamaño población
	private int numMaxGen = 100; // número máximo de generaciones
	...
	private double probMut = 0.05; // probabilidad de mutación
	...
	public void start() {
		...
		System.out.println("La solución es: " + elMejor.getFenotipo());
	...
	private void readParams() {
		...
		System.out.println("Introduce los parámetros base: \n" + "\n - Tam de la Población (default 100): ");
		tamPob = Integer.parseInt(sc.next());
		System.out.println(" - Generaciones máx (default: 100)");
		numMaxGen = Integer.parseInt(sc.next());
		System.out.println(" - % de Cruce (default: 60)");
		probCruce = Double.parseDouble(sc.next()) / 100;
		System.out.println(" - % de Mutación (default: 5)");
		probMut = Double.parseDouble(sc.next()) / 100;
		System.out.println(" - Discretización del intervalo (default: 0.001)");
